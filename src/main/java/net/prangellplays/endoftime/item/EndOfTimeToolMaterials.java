...
public enum EndOfTimeToolMaterials implements ToolMaterial {
    ...
    EndOfTimeToolMaterials(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
